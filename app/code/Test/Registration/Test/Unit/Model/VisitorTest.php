...
namespace Test\Registration\Test\Unit\Model;
...
class VisitorTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->visitor = $this->objectManagerHelper->getObject('Test\Registration\Model\Visitor', $arguments);
    }
    ...
    public function testIsModuleIgnored()
    {
        $this->visitor = $this->objectManagerHelper->getObject(
            'Test\Registration\Model\Visitor',
            [
                'registry' => $this->registry,
                'session' => $this->session,
                'resource' => $this->resource,
